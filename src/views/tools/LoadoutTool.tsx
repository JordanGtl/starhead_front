...
const LoadoutTool = () => {
  const { t }    = useTranslation();
  useSEO({ title: "Outil de configuration", description: "Configurez et optimisez l'équipement de vos vaisseaux Star Citizen.", path: "/tools/loadout" });
