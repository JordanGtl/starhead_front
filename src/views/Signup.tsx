...
const Signup = () => {
  ...
  useSEO({ title: "Inscription", path: "/signup", noindex: true });
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <label htmlFor="accept-cgu" className="text-xs text-muted-foreground leading-relaxed cursor-pointer">
                J'ai lu et j'accepte les{" "}
                <Link href="/legal/cgu" target="_blank" className="text-primary hover:underline">
                  Conditions Générales d'Utilisation
                </Link>{" "}
                ainsi que la{" "}
                <Link href="/legal/politique-de-confidentialite" target="_blank" className="text-primary hover:underline">
            ...
            <button
              ...
              className="h-10 w-full rounded-md bg-primary font-display text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {t("auth.signupButton")}
            </button>
          </form>
          ...
          <div className="mt-6">
            <div className="relative flex items-center gap-3">
              ...
              <span className="text-xs text-muted-foreground/50">ou s'inscrire avec</span>
              <div className="h-px flex-1 bg-border" />
            </div>
            <div className="mt-4 flex flex-col gap-2">
              <button
                ...
                className="flex h-10 w-full items-center justify-center gap-2.5 rounded-md border border-border bg-secondary text-sm font-medium text-foreground transition-colors hover:bg-secondary/60"
              >
              ...
              <button
                ...
                className="flex h-10 w-full items-center justify-center gap-2.5 rounded-md border border-[#5865F2]/30 bg-[#5865F2]/10 text-sm font-medium text-[#5865F2] transition-colors hover:bg-[#5865F2]/20"
              >
