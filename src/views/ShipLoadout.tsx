...
const ShipLoadout = () => {
  ...
  if (!ship) {
    return (
      <div className="container flex min-h-[60vh] flex-col items-center justify-center text-center">
        ...
        <Link href="/ships" className="mt-4 text-primary hover:underline">← {t("loadout.backToShips")}</Link>
      </div>
    );
  }
  ...
  return (
    <div className="container py-8">
      <Link href={`/ships/${id}`} className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted-foreground transition-colors hover:text-primary">
